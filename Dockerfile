...
RUN echo "unsafe-perm=true" > ~/.npmrc && \
    ...
    ./mvnw -B clean package -DskipTests -Pbuild-distr -Pspark-3.5 -Pinclude-hadoop -Phadoop3 -Pspark-scala-2.12 -Pweb-angular -Pweb-dist -Pflink-117 && \
    # Example with doesn't compile all interpreters
    # ./mvnw -B package -DskipTests -Pbuild-distr -Pspark-3.5 -Pinclude-hadoop -Pspark-scala-2.12 -Pweb-classic -Pweb-dist -pl '!groovy,!livy,!hbase,!file,!flink' && \
